...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var phoneMask = new imask__WEBPACK_IMPORTED_MODULE_4__["default"](inputPhone, phoneMaskOptions); // Phone Mask
  // -------------------------------------------------------------------
  // Sticky Header
  ...
  countryRadioBtns.forEach(function (country) {
  ...
  form.addEventListener("submit", function (e) {
    ...
    if (emptyInputs.length === 0 && validateName(nameVal) && !selected.classList.contains("error")) {
      form.submit();
      form.reset();
      alert("Please wait...");
    }
...
/******/ __webpack_require__.O(0, ["vendors-node_modules_babel_polyfill_lib_index_js","vendors-node_modules_imask_esm_index_js-node_modules_simplebar_dist_simplebar_esm_js"], () => (__webpack_exec__("../node_modules/@babel/polyfill/lib/index.js"), __webpack_exec__("./js/main.mjs")));
